...
class OpenAIModerationGuardrail(OpenAIGuardrailBase, CustomGuardrail):
    ...
    async def async_post_call_hook(
        ...
        """
        verbose_proxy_logger.info("OpenAI Moderation: Running post-call response scan")
    ...
    async def async_post_call_streaming_iterator_hook(
        ...
        verbose_proxy_logger.info("OpenAI Moderation: Running streaming response scan")
